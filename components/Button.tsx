...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900 hover:border-slate-300 focus:ring-slate-200",
  ...
  return (
    ...
    >
      {isLoading && (
        <svg className="animate-spin h-4 w-4 current-color" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
